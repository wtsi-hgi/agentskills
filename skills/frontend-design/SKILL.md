...
- Prove every perceptual result per **testing-principles** § Perceptual
  Requirements. Borders, focus rings, selection states, hover states, and
  animation end states all fall under it.

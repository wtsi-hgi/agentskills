...
2. Read the go-conventions skill. It defines code quality standards, GoConvey
   ...
   commands that all Go implementation must follow.
...
1. Implement ONE item at a time, writing all GoConvey tests corresponding to the
   acceptance tests in spec.md, then writing the implementation code to make
   those tests pass - strictly following the TDD cycle above.
2. Consult spec.md for the full acceptance test details, function signatures,
